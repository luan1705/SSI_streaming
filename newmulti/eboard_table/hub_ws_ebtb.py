...
async def redis_listener():
    pubsub = r.pubsub()
    await pubsub.psubscribe("ebtb_*")  # nhận tất cả kênh ws:1..ws:12
    logging.info("Hub subscribed to Redis pattern: ebtb_*")
...
# Chạy: uvicorn hub_ws:app --host 0.0.0.0 --port 9000
